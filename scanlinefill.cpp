...
//float fillRGB[3] = { 1.0, 0.5, 0.0 }; // Default fill color is orange
//
//void init()
//{
...
//                {
//                    glColor3fv(fillRGB); // Use the user-specified fill color
//                    glBegin(GL_POINTS);
//                    glVertex2f(j, i);
//                    glEnd();
//                }
...
//        scanf_s("%f %f %f", &fillRGB[0], &fillRGB[1], &fillRGB[2]);
//    }
//    else if (id == 2)
//        flag = 0;
//    else
