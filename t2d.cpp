...
//// scale vars
//int sx_scale = 0, sy_scale = 0, sc_scale = 0, strack_scale = 0;
//// pencil
//int pencil = 0;
//// rotation
//int rot = 0, rx = 0, ry = 0, rottrack = 0, grxmin, grymin;
//// shear
//int sx_shear = 0, sy_shear = 0, sc_shear = 0, strack_shear = 0;
//
//class points {
//    int x;
//    int y;
...
//    float scalex = 1 + (tempx - sx_scale) / 100;
//    float scaley = 1 + (tempy - sy_scale) / 100;
//    if (scalex < 0)
//        scalex = -1 * scalex;
//    if (scaley < 0)
//        scaley = -1 * scaley;
...
//        glFlush();
//    }
//    if (btn == GLUT_LEFT_BUTTON && state == GLUT_DOWN && sc_scale) {
//        sx_scale = x;
//        sy_scale = y;
//    }
